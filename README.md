...
- Unit Menu: Allows you to both spawn units and transform into a different unit, as well as set the wave number. (Disabled in campaign)
- Block Menu: Allows you to place any block in the game. (Disabled in campaign)
